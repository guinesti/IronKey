...
class _IronKeyScreenState extends State<IronKeyScreen> {
  ...
  PasswordType passwordSelectorType = PasswordType.pin;
                        ...
                        children: [
                          Expanded(
                            child: RadioListTile(
                              ...
                              groupValue: passwordSelectorType,
                              title: Text("Pin"),
                              onChanged: (value) {
                                setState(() {
                                  passwordSelectorType = value!;
                                });
                              },
                            ),
                          ),
